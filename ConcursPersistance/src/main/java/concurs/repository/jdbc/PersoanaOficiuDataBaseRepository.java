...
public class PersoanaOficiuDataBaseRepository implements PersoanaOficiuRepository {
    ...
    public PersoanaOficiuDataBaseRepository(@Qualifier("props")Properties props){
        this.logger.info("Initializing PersoanaOficiu with properties: {}",props);
        this.jbdcUtils=new JdbcUtils(props);

    }
    @Autowired
    public PersoanaOficiuDataBaseRepository(
